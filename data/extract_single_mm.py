...
def extract_single_mm(df_dir, mm_name, target_dir, extract_as='jpg'):
    ...
    if extract_as == 'csv':
        ...
        # TODO: Crop the car from bounding box, then save if separately
        pass
    elif extract_as == 'record':
        # TODO: Save target mm as tfrecords
        pass
    elif extract_as == 'recordCrop':
        # TODO: Same as jpgCrop, but with tfrecords
        pass
